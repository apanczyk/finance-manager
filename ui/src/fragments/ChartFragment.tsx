            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', }}>
                ...
                <ResponsiveContainer aspect={3}>
                    ...
                    >
                        ...
                        <Line type="monotone" dataKey="outcome" stroke="#8884d8" strokeWidth="5" dot={{ fill: "#2e4355", stroke: "#8884d8", strokeWidth: 2, r: 5 }} activeDot={{ fill: "#2e4355", stroke: "#8884d8", strokeWidth: 5, r: 10 }} />
                    </LineChart>
                </ResponsiveContainer>
            </Box>
        </>
